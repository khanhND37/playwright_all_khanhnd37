 ...
 */
test.describe("Login to ShopBase and select one shop to go <4> @TS_SB_DASHBOARD_01 @PERF", async () => {
  test("Login and verify <4> @TC_SB_DB_LGIN_01 @PERF_04", async ({ page, conf }) => {
