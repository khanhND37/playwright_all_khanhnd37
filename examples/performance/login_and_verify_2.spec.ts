 ...
 */
test.describe("Login to ShopBase and select one shop to go <2> @TS_SB_DASHBOARD_01 @PERF", async () => {
  test("Login and verify <2> @TC_SB_DB_LGIN_01 @PERF_02", async ({ page, conf }) => {
