...
test.describe("Add custom text for legal pages into store PLB", () => {
  ...
  test(`@SB_NEWECOM_SP_31 [PLB] Verify Add custom text khi Customize các pages legal`, async ({ conf, context }) => {
    let SFPage;
  ...
  test(`@SB_NEWECOM_SP_32 [PLB] Verify Add custom text sử dụng template variables khi Customize các pages legal`, async ({
    context,
    conf,
  }) => {
    let SFPage;
