...
test.describe("Customize static page pb", () => {
  ...
  test("@SB_NEWECOM_SP_33 - [PB] Verify các action trong list page của shop PB được pull từ shop template", async ({
    conf,
  }) => {
