...
test.describe("Verify conversion analytics on PB", () => {
  ...
  test(`@SB_ANA_CONVER_05 On PB, verify Conversion Analytics theo Hour cùng các điều kiện khác`, async ({
    conf,
    authRequest,
  }) => {
  ...
  test(`@SB_ANA_CONVER_06 On PB, verify Conversion Analytics theo Day cùng các điều kiện khác`, async ({
    conf,
    authRequest,
  }) => {
  ...
  test(`@SB_ANA_CONVER_07 On PB, verify Conversion Analytics theo Week cùng các điều kiện khác`, async ({
    conf,
    authRequest,
  }) => {
  ...
  test(`@SB_ANA_CONVER_08 On PB, verify Conversion Analytics theo Month cùng các điều kiện khác`, async ({
    conf,
    authRequest,
  }) => {
