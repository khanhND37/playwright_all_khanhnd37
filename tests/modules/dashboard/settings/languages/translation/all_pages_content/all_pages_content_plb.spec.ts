...
test.describe("Verify Enable auto translate All pages content - Plusbase ", () => {
  ...
  const caseDataEnable = loadData(__dirname, "DATA_DRIVEN_ENABLE_AUTO_TRANSLATE_PLB");
...
test.describe("Verify Disable auto translate All pages content - Plusbase ", () => {
  let dashboardPage: TranslationDetail;
  let duplicatedTheme: ShopTheme;
  let dataDBTargetLanguage;
  let data;
  ...
  const caseDataDisable = loadData(__dirname, "DATA_DRIVEN_DISABLE_AUTO_TRANSLATE_PLB");
