...
import { SbWebBuilderBcreB } from "./padding-ui-setting";

test.describe("Verify setting padding của customization service block", () => {
  let dashboard: Page;
  ...
  test(`@SB_WEB_BUILDER_BCRE_BCS_16 Verify block customization service khi thực hiện setting padding`, async ({
    page,
    conf,
    context,
    snapshotFixture,
      ...
      await test.step(step.name, async () => {
        ...
        for (const align of aligns) {
          ...
          await snapshotFixture.verify({
            page: wbCsPage.page,
            selector: wbCsPage.getXpathSidebarSetting("padding"),
...
test.describe("Verify setting paddingcủa question block", () => {
  let dashboard: Page;
  let wbCsPage: WbPageCustomizationService;
  let productHandle: string;
  ...
  test(`@SB_WEB_BUILDER_BCRE_BSQ_17 Verify block question khi thực hiện setting padding`, async ({
    page,
    conf,
    context,
    snapshotFixture,
