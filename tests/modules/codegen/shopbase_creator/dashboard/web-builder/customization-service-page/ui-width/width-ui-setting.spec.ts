...
import { SbWebBuilderBcreBcs09 } from "./width-ui-setting";

test.describe("Verify setting width của customization service block", () => {
  let dashboard: Page;
  ...
  test(`@SB_WEB_BUILDER_BCRE_BCS_09 Verify block customization service khi thực hiện setting Width`, async ({
    page,
    conf,
    context,
    snapshotFixture,
    ...
    const caseConf = conf.caseConf as SbWebBuilderBcreBcs09;
      ...
      await test.step(step.name, async () => {
        ...
        for (const datum of data) {
          ...
          await snapshotFixture.verify({
            page: wbCsPage.page,
            selector: wbCsPage.getXpathSidebarSetting("width"),
...
test.describe("Verify setting width của question block", () => {
  let dashboard: Page;
  let wbCsPage: WbPageCustomizationService;
  let productHandle: string;
  ...
  test(`@SB_WEB_BUILDER_BCRE_BCS_17 Verify block question khi thực hiện setting Width`, async ({
    page,
    conf,
    context,
    snapshotFixture,
