...
import { SbWebBuilderBcreB } from "./shadow-ui-setting";
...
test.describe("Verify setting shadow của customization service block", () => {
  ...
  test(`@SB_WEB_BUILDER_BCRE_BCS_14 Verify block customization service khi thực hiện setting shadow`, async ({
    page,
    conf,
    context,
    snapshotFixture,
...
test.describe("Verify setting shadow của question block", () => {
  ...
  test(`@SB_WEB_BUILDER_BCRE_BSQ_15 Verify block question khi thực hiện setting shadow`, async ({
    page,
    conf,
    context,
    snapshotFixture,
