...
test.describe("Verify checkout cổng Paypal với currency theo location buyer", async () => {
  ...
  test(`@SB_SET_GM_MC_269 Kiểm tra auto select country (United States, United Kingdom, Canada), currency theo location của buyer khi buyer truy cập sf và checkout product qua Paypal`, async ({
    conf,
    dashboard,
    authRequest,
  }) => {
  ...
  test(`@SB_SET_GM_MC_270 Kiểm tra auto select country (German, Brazil), currency theo location của buyer khi buyer truy cập sf và checkout product qua Paypal`, async ({
    conf,
    dashboard,
    authRequest,
  }) => {
  ...
  test(`@SB_SET_GM_MC_271 Kiểm tra auto select country (India, Sweden), currency theo location của buyer khi buyer truy cập sf và checkout product qua Paypal`, async ({
    conf,
    dashboard,
    authRequest,
  }) => {
