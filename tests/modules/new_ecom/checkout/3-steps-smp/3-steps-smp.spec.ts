...
import type { OrderAfterCheckoutInfo, OrderSummary } from "@types";
...
test.describe("Checkout new ecom SMP", () => {
  ...
  const casesID = "SB_CHE_SMP_NE_3STEPS";
  ...
  test(`@SB_NEWECOM_CO_19 Kiểm tra order detail khi checkout thành công với cổng SMP, checkout 3 steps`, async ({
    page,
    conf,
    authRequest,
    dashboard,
