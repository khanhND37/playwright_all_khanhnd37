...
test.describe("Checkout new ecom without setting PPC", () => {
  ...
  const casesID = "SB_CHE_PP_HOST_NE_3STEPS";
...
test.describe("Checkout new ecom with setting PPC", () => {
  ...
  const casesID = "SB_CHE_PP_HOST_3STEPS_PPC";
  const conf = loadData(__dirname, casesID);
...
test.describe("Checkout new ecom without setting PPC", () => {
  ...
  const casesID = "SB_CHE_PP_HOST_NE_1PAGE";
  const conf = loadData(__dirname, casesID);
...
test.describe("Checkout new ecom with setting PPC", () => {
  ...
  const casesID = "SB_CHE_PP_HOST_1PAGE_PPC";
  const conf = loadData(__dirname, casesID);
