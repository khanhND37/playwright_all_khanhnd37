...
test.describe("SB_CHE_CHEN_NE_3STEPS_PPC_EU_PAYMENTS Checkout new ecom with setting PPC via EU payment", () => {
  ...
  const casesID = "SB_CHE_CHEN_NE_3STEPS_PPC_EU_PAYMENTS";
