...
test.describe("SB_CHE_CHEN_NE_3STEPS_PPC_UK_PAYMENTS Checkout new ecom with setting PPC via UK payment", () => {
  ...
  const casesID = "SB_CHE_CHEN_NE_3STEPS_PPC_UK_PAYMENTS";
