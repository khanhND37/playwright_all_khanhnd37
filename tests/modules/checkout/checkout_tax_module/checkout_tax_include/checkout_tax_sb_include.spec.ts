...
test.describe("[include] Kiểm tra tax line ở checkout page, thankyou page, order stt page", () => {
  const caseName = "TC_SB_CHE_TSB_02";
  ...
  conf.caseConf.data.forEach(
    ({
      ...
      test(`[include] Kiểm tra tax line ở checkout page, thankyou page, order stt page for case @${caseID}`, async ({
        page,
        conf,
        request,
        authRequest,
...
test.describe("[include] Kiểm tra tax line ở checkout page, thankyou page, order stt page, order có PPC item", () => {
  test(`
  [include] Kiểm tra tax line ở checkout page, thankyou page, order stt page for case @TC_SB_SET_TM_TSB_453`, async ({
    page,
    conf,
    request,
    authRequest,
...
test.describe("[include] Kiểm tra tax line ở checkout page, thankyou page, order stt page, order có PPC item", () => {
  ...
  order stt page for case @TC_SB_SET_TM_TSB_454`, async ({ page, conf, request, authRequest }) => {
    // prepair data for
    const domain = conf.suiteConf.domain;
    const productInfo = conf.caseConf.product;
    const productPPC = conf.caseConf.product_ppc;
