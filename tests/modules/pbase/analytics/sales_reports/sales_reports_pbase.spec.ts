...
test.describe("Verify sale report", async () => {
  test(`@SB_ANA_SALE__16 On PB, verify Report by Campaign kèm các điều kiện khác`, async ({ conf, authRequest }) => {
    await test.step(`Filter Sales reports với: Report by Campaign, Has sales: both, Today`, async () => {
      await salesReports.gotoSalesReport();
      await salesReports.page.selectOption(salesReports.xpathReportByFilter, "campaign");
    ...
    await test.step(`Change filter Sales reports với: Report by Campaign, Has sales: yes, Today`, async () => {
    ...
    await test.step(`Change filter Sales reports với: Report by Campaign, Has sales: no, Today`, async () => {
    ...
    await test.step(`Change filter Sales reports với: Report by Campaign, Has sales: both, Yesterday`, async () => {
    ...
    await test.step(`Change filter Sales reports với: Report by Campaign, Has sales: yes, Yesterday`, async () => {
      await salesReports.filterWithHasSales("yes");
      await expect(salesReports.page.locator(salesReports.xpathHeaderTable)).toHaveText(conf.caseConf.header_list);
      if (dataAnalytics.summary.view_content == 0 || yesSales == 0) {
        await expect(salesReports.page.locator(salesReports.xpathNoDataForReports)).toBeVisible();
    ...
    await test.step(`Change filter Sales reports với: Report by Campaign, Has sales: no, Yesterday`, async () => {
      await salesReports.filterWithHasSales("no");
      if (dataAnalytics.summary.view_content == 0 || noSales == 0) {
        await expect(salesReports.page.locator(salesReports.xpathNoDataForReports)).toBeVisible();
      } else {
    ...
    await test.step(`Change filter Sales reports với: Report by Campaign, Has sales: both, Last month`, async () => {
    ...
    await test.step(`Change filter Sales reports với: Report by Campaign, Has sales: yes, Last month`, async () => {
      await salesReports.filterWithHasSales("yes");
      await expect(salesReports.page.locator(salesReports.xpathHeaderTable)).toHaveText(conf.caseConf.header_list);
      if (dataAnalytics.summary.view_content == 0 || yesSales == 0) {
        await expect(salesReports.page.locator(salesReports.xpathNoDataForReports)).toBeVisible();
    ...
    await test.step(`Change filter Sales reports với: Report by Campaign, Has sales: no, Last month`, async () => {
      await salesReports.filterWithHasSales("no");
      if (dataAnalytics.summary.view_content == 0 || noSales == 0) {
        await expect(salesReports.page.locator(salesReports.xpathNoDataForReports)).toBeVisible();
      } else {
    ...
    await test.step(`Change filter Sales reports với: Report by Campaign, Has sales: both, Month to date`, async () => {
    ...
    await test.step(`Change filter Sales reports với: Report by Campaign, Has sales: yes, Month to date`, async () => {
      await salesReports.filterWithHasSales("yes");
      await expect(salesReports.page.locator(salesReports.xpathHeaderTable)).toHaveText(conf.caseConf.header_list);
      if (dataAnalytics.summary.view_content == 0 || yesSales == 0) {
        await expect(salesReports.page.locator(salesReports.xpathNoDataForReports)).toBeVisible();
    ...
    await test.step(`Change filter Sales reports với: Report by Campaign, Has sales: no, Month to date`, async () => {
      await salesReports.filterWithHasSales("no");
      if (dataAnalytics.summary.view_content == 0 || noSales == 0) {
        await expect(salesReports.page.locator(salesReports.xpathNoDataForReports)).toBeVisible();
      } else {
    ...
    await test.step(`Change filter Sales reports với: Report by Campaign, Has sales: both, 15 days in last month`, async () => {
    ...
    await test.step(`Change filter Sales reports với: Report by Campaign, Has sales: yes, 15 days in last month`, async () => {
      await salesReports.filterWithHasSales("yes");
      await expect(salesReports.page.locator(salesReports.xpathHeaderTable)).toHaveText(conf.caseConf.header_list);
      if (dataAnalytics.summary.view_content == 0 || yesSales == 0) {
        await expect(salesReports.page.locator(salesReports.xpathNoDataForReports)).toBeVisible();
    ...
    await test.step(`Change filter Sales reports với: Report by Campaign, Has sales: no, 15 days in last month`, async () => {
      await salesReports.filterWithHasSales("no");
      if (dataAnalytics.summary.view_content == 0 || noSales == 0) {
        await expect(salesReports.page.locator(salesReports.xpathNoDataForReports)).toBeVisible();
      } else {
    ...
    await test.step(`Change filter Sales reports với: Report by Campaign, Has sales: both, Last 90 days`, async () => {
    ...
    await test.step(`Change filter Sales reports với: Report by Campaign, Has sales: yes, Last 90 days`, async () => {
      await salesReports.filterWithHasSales("yes");
      await expect(salesReports.page.locator(salesReports.xpathHeaderTable)).toHaveText(conf.caseConf.header_list);
      if (dataAnalytics.summary.view_content == 0 || yesSales == 0) {
        await expect(salesReports.page.locator(salesReports.xpathNoDataForReports)).toBeVisible();
    ...
    await test.step(`Change filter Sales reports với: Report by Campaign, Has sales: no, Last 90 days`, async () => {
      await salesReports.filterWithHasSales("no");
      if (dataAnalytics.summary.view_content == 0 || noSales == 0) {
        await expect(salesReports.page.locator(salesReports.xpathNoDataForReports)).toBeVisible();
      } else {
    ...
    await test.step(`Change filter Sales reports với: Report by Campaign, Has sales: both, Last 90 days, 2 stores`, async () => {
    ...
    await test.step(`Change filter Sales reports với: Report by Campaign, Has sales: yes, Last 90 days, 2 stores`, async () => {
      await salesReports.filterWithHasSales("yes");
      await expect(salesReports.page.locator(salesReports.xpathHeaderTable)).toHaveText(conf.caseConf.header_list);
      if (dataAnalytics.summary.view_content == 0 || yesSales == 0) {
        await expect(salesReports.page.locator(salesReports.xpathNoDataForReports)).toBeVisible();
    ...
    await test.step(`Change filter Sales reports với: Report by Campaign, Has sales: no, Last 90 days, 2 stores`, async () => {
      await salesReports.filterWithHasSales("no");
      if (dataAnalytics.summary.view_content == 0 || noSales == 0) {
        await expect(salesReports.page.locator(salesReports.xpathNoDataForReports)).toBeVisible();
      } else {
  ...
  test(`@SB_ANA_SALE__17 On PB, verify Report by Gross Profit kèm các điều kiện khác`, async ({
    authRequest,
    conf,
  }) => {
    ...
    //   const feedFileData = await readFileCSV(feedFile, "\t");
    //   expect(feedFileData[0][0]).toContain(
    //     (await salesReports.locatorFirstSalesOrGrossProfit.textContent()).trim().slice(1),
    //   );
    // });
  });

  test(`@SB_ANA_SALE__18 On PB, verify Report by Variant Option kèm các điều kiện khác`, async ({
    authRequest,
    conf,
  }) => {
    ...
    await test.step(`Change filter Sales reports với: 2 stores, Last 90 days, Report by Variant Option, Product has sales: both, Variant option: null`, async () => {
      ...
      if (dataAnalytics.summary.add_to_cart + dataAnalytics2.summary.add_to_cart == 0) {
        await expect(salesReports.page.locator(salesReports.xpathNoDataForReports)).toBeVisible();
      } else {
        sumProfit = await orderAPI.getPLBOrdersListWithDate(authRequest, filterDate.fromDate, filterDate.toDate);
        actProfit = (await salesReports.page.locator(salesReports.xpathTotalSalesOrGrossProfit).textContent()).trim();
    ...
    await test.step(`Change filter Sales reports với các điều kiện rồi search product title`, async () => {
      ...
      await salesReports.page.waitForTimeout(2000);
      await expect(salesReports.page.locator(salesReports.xpathHeaderTable)).toHaveText(conf.caseConf.header_list);
      // await expect(salesReports.locatorProductTitleInSalesReports).toContainText(conf.suiteConf.product_title);
      await expect(
  ...
  test(`@SB_ANA_SALE__21 On PB, verify Report by Source / Medium kèm các điều kiện khác`, async ({
    authRequest,
    conf,
  }) => {
