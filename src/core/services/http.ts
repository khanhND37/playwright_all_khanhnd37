...
export type HttpHeader = Record<string, string> | Array<Record<string, string>>;
/*eslint-disable-next-line*/
export type HttpResponseData = any;

/*eslint-disable-next-line*/
export type HttpRequestBody = any;
...
export interface HttpError<T = HttpResponseData> {
  name: string;
  message: string;
 ...
 * @param body
 */
export function isStream(body: HttpRequestBody): boolean {
  return (
